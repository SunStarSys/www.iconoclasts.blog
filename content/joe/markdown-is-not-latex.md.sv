...
GFM höll fast vid specifikationens designmål ända fram till [Microsoft bastardized den isolerade dollartecknet för att villkorligt konvertera det till en $$\LaTeX$$ tecken](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/writing-mathematical-expressions#writing-inline-expressions) på grund av någon föråldrad, ful crapware som heter MathJax som inte hade något att göra med Markdown, och det faktum att dessa rövhål inte vill främja $$\KaTeX$$ Utan en muta från Khan Academy.
