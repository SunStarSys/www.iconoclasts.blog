...
Почему это важно?  Ну, для начала позвольте мне обратиться к распространенному заблуждению о необходимости лицензионных соглашений участника (ICLA) для пользователей Apache.  Многие люди, похоже, не понимают, что в отношении отдельных произведений автора, нет никакой разницы между применимым языком в [ICLA](http://www.apache.org/licenses/icla.txt) и [Apache License 2.0](http://www.apache.org/licenses/license-2.0).
