...
Este artículo establece la bijetividad de este mapa para los colectores de Riemann cerrados (hasta la isometría de Riemann en su dominio). Otros resultados que aplican estas técnicas para describir su imagen (y a la inversa), dentro de determinados espacios de métricas, están empezando [[AA25]](#AA25). Allí, Anshul Adve aborda con éxito los espacios tangentes de unidades de 2 orbifolds compactos e hiperbólicos utilizando estas mismas **constantes de estructura** de la Teoría de Campo Conformal.
