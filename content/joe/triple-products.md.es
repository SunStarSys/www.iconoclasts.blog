...
Para suficiencia, ahora consideramos el mapa de bases ortonormales lineales y bijetivas de función propia $$F$$ de $$C^\infty(M)$$ a $$C^\infty(N)$$ y observamos que de los cálculos en los [Preliminarios](#no-do-preliminarios).
