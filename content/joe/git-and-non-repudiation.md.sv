...
[Ej avvisande](http://en.wikipedia.org/wiki/Non-repudiation).
...
Med git, eller distribuerad versionskontroll i allmänhet, {# lede #}Det finns en tydlig skillnad mellan "åtagandets" historia och "uppladdningens" historia.{# lede #} &mdash;

Från Apache Software Foundation(https://www.apache.org/).

Varför är detta viktigt?  Tja till att börja med låt mig ta itu med en vanlig missuppfattning om behovet av bidragsgivare licensavtal (ICLA) för Apache-företag.  Många människor verkar inte förstå att det inte finns någon skillnad mellan det tillämpliga språket i [ICLA] när det gäller en uppdragsgivares enskilda författarverk.(http://www.apache.org/licenses/icla.txt) och [Apache-licens 2.0](http://www.apache.org/licenses/license-2.0).
