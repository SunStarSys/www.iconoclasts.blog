...
Поощрение постепенных изменений с помощью автоматических процессов тестирования, продвижения и выпуска в запланированной последовательности – отличный способ добиться успеха, но большая часть контроля качества в развертываниях SaaS/PaaS включает в себя принятие *[развитие на основе ствола](https://trunkbaseddevelopment.com).
...
Назад в пред-[CFEngine](https://cfengine.com).
...
## Виртуализация и контейнеризация: a [Домашние животные против скота](http://cloudscaling.com/blog/cloud-computing/the-history-of-pets-vs-cattle/).
