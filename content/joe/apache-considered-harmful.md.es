...
Expliqué los objetivos de diseño varias veces a lo largo de los años, incluso en 2012. [dev@httpd](https://lists.apache.org/list.html?dev@httpd.apache.org:2012-04).

## Reunión de nubes de tormenta

Si bien esta visión tuvo un gran éxito, con enlaces lingüísticos disponibles para varios idiomas como [`Perl`](https://perl.apache.org/), [`PHP`](https://github.com/php/php-src/blob/master/main/rfc1867.c),  [`TCL`](https://tcl.apache.org/), [`R`](https://github.com/jeffreyhorner/rapache), etc., desde aproximadamente 2010 ha demostrado ser trágico para el [comunidad de usuarios existente](https://webtechsurvey.com/technology/smod_apreq2) <a class="border border-warning text-muted reference-link" href="#commentAA" id="commentAA-link" title="{{commentAA.headers.title}}">consistente en todos ellos</a>, no solo los miembros de la `Perl`

¿Qué ha pasado? [Philip Gollucci](https://projects.apache.org/committee.html?httpd#:~:text=Philip%20M.%20Gollucci), un colega mío Perl/FreeBSD en ese momento, comenzó a agitar que promoviéramos el proyecto que se lanzaría desde el propio servidor HTTPd. Qué {# lede #}Felipe no sabía muy bien entonces era lo absolutamente [peevish, vapid y territorial](https://www.mail-archive.com/dev@httpd.apache.org/msg77781.html) ese equipo se había convertido{# lede #}, lo que habría significado tener que colaborar con ellos directamente en [decisiones orientadas al usuario](https://www.mail-archive.com/dev@httpd.apache.org/msg77806.html).
...
Si usted se pregunta cómo algo con una prueba de regresión rota termina en [CPAN](https://cpan-digger.perlmaven.com/dist/libapreq2), tendrás que ver cómo [RELENG](https://httpd.apache.org/dev/release.html).

Cuento corto, [comentaron la prueba](http://svn.apache.org/viewvc?view=revision&revision=1903489) y lo envió de todos modos, y lo llamó una versión de seguridad que [solucionó una vulnerabilidad cada versión anterior era susceptible de](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1018191).
...
¿Por qué me importa ahora? Porque yo soy el chupador [los usuarios buscan respuestas](https://www.mail-archive.com/dev@httpd.apache.org/msg77426.html).
