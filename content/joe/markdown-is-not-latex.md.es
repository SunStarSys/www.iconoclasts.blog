...
Por supuesto, esto fue totalmente intencional, porque [galardonado](https://itsfoss.com/online-markdown-editors/#:~:text=Editor.md), [:editormd-logo: equipos de ingeniería de clase mundial](http://editor.md.ipandao.com) habían resuelto $$\KaTeX$$ con [límites de token de doble dólar](https://github.com/pandao/editor.md/blob/master/examples/katex.html#L45) (o vallado) `math` bloques) para **cualquier expresión matemática** &mdash; dependiendo del *posicionamiento relativo de los dobles dólares en el(los) párrafo(s)* para distinguir *en línea* de *bloque* $$\KaTeX$$ proceso &mdash; [**en 2015**](https://github.com/pandao/editor.md/releases/tag/v1.5.0); **cuatro años antes de la publicación de la especificación de GFM**.
...
¿Qué pasa con un par de variables Ruby / Perl en una firma de función como `foo($v,$w)`? El mismo problema con la ingenua especulación. Tener Claude[^2] analizarlo todo?
