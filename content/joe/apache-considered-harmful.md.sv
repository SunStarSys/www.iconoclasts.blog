...
Även om denna vision var väldigt framgångsrik, med språkbindningar tillgängliga för flera språk som [`Perl` ](https://perl.apache.org/  ) , [`PHP` ](https://github.com/php/php-src/blob/master/main/rfc1867.c  ) ,  [`TCL` ](https://tcl.apache.org/  ) , [`R` ](https://github.com/jeffreyhorner/rapache  )Sedan 2010 har det varit tragiskt för [befintlig användargrupp ](https://webtechsurvey.com/technology/mod_apreq2  )  <a href="#commentAA" class="border border-warning text-muted reference-link" id="commentAA-link" title=" {{commentAA.headers.title}} > > Bestående av alla</aInte bara medlemmarna i `Perl` Gemenskap.

Vad hände? [Philip Gollucci ](https://projects.apache.org/committee.html?httpd#:~:text=Philip%20M.%20Gollucci  ) , en Perl / FreeBSD kollega till mig vid den tiden, började upprörande att vi främjar projektet som ska släppas inifrån HTTPd servern själv. Vad  {# lede #}Philip visste inte så bra då var hur fullständigt [peevish, ånga och territoriell ](https://www.mail-archive.com/dev@httpd.apache.org/msg77781.html  )Det laget hade blivit {# lede #} , vilket skulle ha inneburit att behöva samarbeta med dem direkt på [användarinriktade beslut ](https://www.mail-archive.com/dev@httpd.apache.org/msg77806.html  )  om kodbasen.

2012 fick Philip vad han ville ha och jag slutade motstå, så han [förgrenade ](https://svn.apache.org/viewvc?view=revision&revision=1201372  )  det befintliga projektet och kopierade `C` bibliotekskomponenter i HTTPd-kärnan.

Antal förlorade

[Under 2018 ](https://www.mail-archive.com/search?l=modperl@perl.apache.org&q=subject:%22Re%5C%3A+New+release+of+libapreq2%22&o=newest&f=1  ) Jag avgick från stiftelsen en masse. Du kan gissa orsakerna.
...
Om du undrar hur något med ett trasigt regressionstest hamnar på [CPAN ](https://cpan-digger.perlmaven.com/dist/libapreq2  ) du måste titta på hur [RELENG ](https://httpd.apache.org/dev/release.html  )  görs i serverprojektet.

Lång historia kort, [ de kommenterade testet ](https://github.com/apache/apreq/commit/ee43f996710aad757b783ee77382ac4a78169602  )  och skickade det ändå och kallade det en säkerhetsutgåva som [ fixade en sårbarhet varje tidigare release var mottaglig för ](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1018191  ) .
...
Varför bryr jag mig nu? För jag är sucker [ användare nå ut till för svar ](https://www.mail-archive.com/dev@httpd.apache.org/msg77426.html  ) som känd ämnesexpert.
