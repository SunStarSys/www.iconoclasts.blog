...
Для обработки таких файлов 10K обычно требуется 8-12 секунд (иногда до 30s).  По сравнению с сборкой @SunStarSys/orion `./test.sh ooo` который [последовательно создает более 20K таких файлов примерно в 2-3x время](https://github.com/SunStarSys/orion/actions/runs/28297700630/job/83840391681#:~:text=44556), кажется, между ними есть **паритет производительности** на наименее сложных, но очень больших веб-сайтах, таких как <https://www.OpenOffice.org>.
