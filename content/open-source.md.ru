...
archived: ~
categories: ~
keywords: открытый исходный код,osi,apache-лицензия,ведущий пользователь
published: ~
status: ~
...
- [mod_perl](https://perl.apache.org/) &mdash;

- [либапрек](https://httpd.apache.org/apreq/) &mdash;
...
- [топ](https://github.com/joesuf4/htop/tree/solaris-stable) &mdash;

- [запечатанный](https://github.com/SunStarSys/sealed) &mdash;
