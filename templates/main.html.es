...
########### ##########         ############# ##########           ############# #############             activo##########             >############ ################### ################# ################           ############### <!              activo##########              <div class="collapse navbar-collapse" id="navbarResponsive">########################### ########################### <!            #################!         <!######################,              #################################!             <! ######################### #################,                  <!##########################!-- #############, <!########, #################, ###############, <! #######, ###############, #############, ###########################, ###, #####, #########, #############, ###, ###, ###, #####, #####, ###############, #######, ###############, ###, #######, ###, ###, #######, ###, ###, #####, ###############, #####, #######, ###, ###, ###, ###########, #######, ### ### #######, #######, ### ### ####### ###, ###, ###, #############, #########, ###, #######, ###, ###, ###, ###, ###, ### #####, ###, #####, ###, ###, ###, ###, ###, ########### ######### #############, ###, ###, ###, ###, ###, ###, ###, ###, ###, ###,13. 
...
{% endifequal %}
  ...
  <li class="nav-item{% if path|starts_with:"/contact.md" %}
      {% block alert %}><a class="nav-link" href="/contact.html{{lang}}">
        </a>
      </li>
  <li class="nav-item dropdown">
  <a href="#" class="nav-link dropdown-toggle" id="products" data-bs-toggle="dropdown" role="button">{% if alert %}<span class="caret">
  </span>{{ alert|markdown }}</a>
  {% endif %}

<ul class="dropdown-menu me-auto mb-2 mb-lg-0" aria-labelledby="products">{% endblock %}{% block content %}<li class="dropdown-item"><a class="nav-link text-dark" href="https://www.sunstarsys.com/orion/index.html{{ lang }}">
  </a>
  </li>
