...
#%%%%%
%            activo
%%            "><div class="collapse navbar-collapse" id="navbarResponsive"> Powered by...
%%%%%%         
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%#%#%#%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%#%%%%%%%%%%%%%%%%%%%%%%#%#%%%%%%#%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%#%#%#%%%%%%%%#%#%#%%%%#%#%%#%#%#%%%%#%#%%%#%#%%%%%%%#%%%%%%%%%%%%%%#%#%#%%#%#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#%%%%%%%%%%%%%%%%%%%
...
{{ lang }}
  {% endif %}
  <ul class="navbar-nav">
    <li class="nav-item{% if path|starts_with:"/bloggers.md" %}<a class="nav-link text" href="/bloggers.html{{lang}}">
    {% endifequal %}
  </a>
  {{ regex }}
{% block alert %}
  ...
  <li class="nav-item{% if path|starts_with:"/contact.md" %}
      {{ alert|markdown }}><a class="nav-link" href="/contact.html{{lang}}">
        </a>
      </li>
  <li class="nav-item dropdown">
  <a href="#" class="nav-link dropdown-toggle" id="products" data-bs-toggle="dropdown" role="button">{% endif %}<span class="caret">
  </span>{% endblock %}</a>
  {% block content %}

<ul class="dropdown-menu me-auto mb-2 mb-lg-0" aria-labelledby="products">{{ breadcrumbs|safe }}{{ headers.title|safe }}<li class="dropdown-item"><a class="nav-link text-dark" href="https://www.sunstarsys.com/orion/index.html{{ lang }}">
  ...
  <script src="/editor.md/js/sequence-diagram.min.js"></script> --&trade;
