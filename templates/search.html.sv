	  ...
	  <div class="right" id="filter">
	    <div class="d-flex float-end">
	    	...
	    	<input class="form-control me-2" type="text" name="filter"
             placeholder="PCRE rekursiv sökning" value="{{ filter }}" />&nbsp;<button class="btn btn-outline-danger" name="submit" type="submit" value="1"><i class="fa fa-filter fa-emoji" title="Filtrera"></i></button>
        </div>
	  </div>
      <div>
        <dl>
