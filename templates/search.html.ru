  ...
  <form class="form-inline row" method="POST">
	  ...
	  <div class="right" id="filter">
	    <div class="d-flex float-end">
	    	...
	    	<input class="form-control me-2" name="filter" placeholder="Рекурсивный поиск PCRE" type="text" value="{{ filter }}" />&nbsp;<button class="btn btn-outline-danger" name="submit" type="submit" value="1"><i class="fa fa-filter fa-emoji" title="Фильтр"></i></button>
        </div>
	  </div>
      <div>
        <dl>
