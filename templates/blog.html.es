     ...
     <div class="essay col-lg-12 container">
       <div style="color:#aaa">
         <small>
           ...
           <em>
			   <a href="/dynamic/search{{path}}?regex=diff=r{{content|vcs_revision}};lang={{lang}};markdown_search=1">Última actualización</a> por <b>{{ content|ssi|vcs_author:lang }}</b> en <b>{{ content|ssi|vcs_date:lang }}</b>
...
{% endifequal %}
       ...
       {{ content|markdown|removetags:"script"|removeattrs:"on\w+"|safe }}
     </div>
{% endblock %}
{% block footer %}
<div class="container">
