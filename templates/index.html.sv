...
{% if permalink %}
<span class="badge bg-info" style="color:#000">Permalänk</span>&nbsp;
{% endif %}
...
<span class="badge bg-danger text-white">
  <a style="color:#fff" href="/dynamic/search{{path|dirname}}/?regex=%23{{k|urlencode}};lang={{lang}};markdown_search=1">#{{k}}</a>
</span>&nbsp;
{% endfor %}
...
<button type="button" class="btn btn-success">
  <a style="color:#fff" href="{{category_root|default_if_none:".."}}/{{c|append:"/index.html"}}{{lang}}">{{c}}</a></button>
&nbsp;
{% endfor %}
...
<div class="card border-warning">
    ...
    <div class="card-header">
      <h3 class="card-title">Kommentarer {% if category_root %}{% if archive_root %} &nbsp;
        <button type="submit" name="uri" value="https://{{website}}{{path|dirname}}/{{path|basename:0|append:".page/comment.md"}}{{lang}}" class="btn btn-sm btn-outline-warning">
          Nytt
        </button>
{% endif %}{% endif %}
      </h3>
    ...
    <div id="comments" class="card-body">
      ...
      {% if c.closed %}
      {% else %}
        <!--#include virtual="{{path|basename:0|append:".page/"}}{{c.key|append:".html"}}{{lang}}" -->
      {% endif %}
      {% endfor %}
    </div>
  </form>
...
<div class="card border-dark">
  <div class="card-header">
    <h3 class="card-title">Bilagor &nbsp;
    <button type="button" class="btn btn-sm btn-outline-dark"><a href="https://cms.sunstarsys.com/redirect?uri=https://{{website}}{{path|dirname}}/{{path|basename:0|append:".page/;action=add"}}">Hantera</a></button>
</h3>
  </div>
  <div class="card-body">
    <ul>
  ...
  <div class="card-header">
    <h3 class="card-title">Länkar &nbsp;
    <button type="button" class="btn btn-sm btn-outline-dark"><a href="https://cms.sunstarsys.com/redirect?uri=https://{{website}}{{path|dirname}}/{{path|basename:0|append:".page/links.md"}}{{lang|append:";action=add"}}">Hantera</a></button></h3>
  </div>
  <div class="card-body">
