...
<li class="nav-item dropdown">
			...
			aria-labelledby="more">
              <li class="dropdown-item">
                <a class="nav-link text-dark" href="https://vcs.sunstarsys.com/repos/svn/public/cms-sites/{{website}}/trunk/content{{path|dirname}}">Источник отделения</a>
              </li>
            ...
            <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ko">Корейский</a></li>
             <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ja">Японский</a></li>
...
<div class="offcanvas offcanvas-end border-primary" tabindex="-1" id="recentVisits" aria-labelledby="recentVisits">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title">Недавно посещённые</h5>
