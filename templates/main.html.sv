...
<div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          <li class="nav-item{% if path|starts_with:"/bloggers.md" %}
            active
            {% endif %}"><a class="nav-link text" href="/bloggers.html{{lang}}">Ikonokloster</a></li>
...
<ul class="dropdown-menu me-auto mb-2 mb-lg-0 {% ifequal lang ".he" %}dropdown-menu-left right{% else %}{% ifequal lang ".ar" %}dropdown-menu-left right{% endifequal %}{% endifequal %}" role="menu"
			aria-labelledby="products">
              ...
              <li class="dropdown-item"><a class="nav-link text-dark"
                href="https://www.sunstarsys.com/orion/plans.html{{ lang }}">Orion: Prissättningsplaner</a></li>
            </ul>
          </li>
...
<li class="nav-item dropdown">
			...
			aria-labelledby="more">
              <li class="dropdown-item">
                <a class="nav-link text-dark" href="https://vcs.sunstarsys.com/repos/svn/public/cms-sites/{{website}}/trunk/content{{path|dirname}}">Platskälla</a>
              </li>
              <li class="dropdown-item divider"></li>
              <li class="dropdown-header text-dark">i18n</li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.en">Engelska</a></li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.es">Spanska</a></li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.de">Tyska</a></li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.fr">Franska</a></li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ru">Ryska</a></li>
              <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.zh-TW">kinesiska</a></li>
            <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ko">Koreanska</a></li>
             <li class="dropdown-item"><a class="nav-link" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ja">Japanska</a></li>
...
<main>
<div id="recent-div" class="position-fixed" style="writing-mode: vertical-rl; top:110px; {% if lang|grep:"[.](ar|he)" %}left:0{% else %}right:0{% endif %}">
...
<div>
<a id="go-to-top" onClick="$('base').remove()" href="#top"><i class="fa fa-circle-arrow-up"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="/contact"><i class="fa fa-at"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://sunstarsys.com/orion/"><img src="/images/sunstar-orion-symbol-linear">&nbsp;Orion&trade;</a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://x.com/sunstarsys"><i class="fa fa-square-x-twitter"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://www.youtube.com/@joeschaefer6982"><i class="fa fa-youtube"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://calendly.com/joe-sunstarsys/30min"><i class="fa fa-calendar"></i></a>&nbsp;<span class="sep"></span>&nbsp;&copy;2026&nbsp;<a href="https://sunstarsys.com/"><img src="/images/sunstarlinear.png"></a>&nbsp;och&nbsp;respektive&nbsp;författare.
</div>
  </footer>
...
<script async type="module">
    ...
    if (document.cookie.indexOf("has_creds") >= 0 && Notification.permission !== "denied") {
...
if (permission === "granted") {
           ...
           if (m)
			 revision = m[1];
           var response = await fetch("/dynamic/search/?regex=notify="+revision+";lang={{lang}};markdown_search=1;as_json=1",
...
<script async="" type="module">
  if (document.cookie.indexOf("has_creds") >= 0) {
