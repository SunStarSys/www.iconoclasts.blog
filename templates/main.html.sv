...
<main>
<div id="recent-div" class="position-fixed" style="writing-mode: vertical-rl; top:110px; {% if lang|starts_with:".he" or lang|starts_with:".ar" %}left:0{% else %}right:0{% endif %}">
